      ...
      v-hover(v-slot:default='{ hover }')
        v-card.mx-auto.pa-4(width='max', height='auto', :elevation='hover ? 12 : 2')
          ...
          v-container.ma-0.pa-2
            ...
            p.black--text.ma-0
              br
              b Гендерная принадлежность:  {{$student->gender}} 
            p.black--text.ma-0
              br
              b Дата рождения: {{$student->birthday}}
            v-divider.my-2
            p.black--text.ma-0
              br
              b Email:  {{$user->email}}
            p.black--text.ma-0
              br
              b Специальность: {{$dep->dep_name_full}}
            p.black--text.ma-0
              br
              b Курс: {{$group->сurs}}
            p.black--text.ma-0
              br
              b Группа:  {{$group->group_name}}
            p.black--text.ma-0
              br
              b Специализация:  {{$dep->specialization}}
            v-divider.my-2
            p.black--text.ma-0
              br
              b Форма обучения:  {{$group->type_of_study}}
            p.black--text.ma-0
              br
              b Вид финансирования: {{$student->type_of_financing}}
            p.black--text.ma-0
              br
