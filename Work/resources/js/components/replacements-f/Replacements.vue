<template lang="pug">
    v-layout.column.wrap
        v-flex.ma-2.mb-0.pa-0.row(v-if="!checkAllGroup")
        ...
        v-flex.ma-2.mt-0.pa-0.row(v-if="!checkAllDate")
        ...
        v-flex.ma-0.mb-2.row(v-for="(groups_key, groups_index) in groups" :key="groups_index" align="center" justify="center")
