...
namespace App\Helpers\FileWrite;
...
class ConfigServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('App\Helpers\FileWrite\Repository', function($app, $items)
        {
		...
		$this->app->singleton('config',function($app) use ($config_items) {
			return $app->make('App\Helpers\FileWrite\Repository', $config_items);
		});
    }
}